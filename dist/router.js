...
var middelwares_1 = require("./modules/middelwares");
var router = (0, express_1.Router)();
/* Product */
router.get('/product', products_1.getProducts);
router.get('/product/:id', products_1.getOneProduct);
router.put('/product/:id', (0, express_validator_1.body)('name').isString(), middelwares_1.handleInputErrors, function (req, res) {
});
router.post('/product', (0, express_validator_1.body)('name').isString(), middelwares_1.handleInputErrors, products_1.createProduct);
...
router["delete"]('/update point/:id', function () { });
